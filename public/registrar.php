...
<body>
    ...
    $password_validada = obtener_post('password');
    ...
    if (isset($login, $password, $password_repeat)) {
        ...
        if (!validar_contraseña($password, $error)){
    ...
    <div class="container mx-auto">
        ...
        <div class="mx-72">
            <form action="" method="POST">
                ...
                <div class="mb-6">
                    <label for="password" class="block mb-2 text-sm font-medium <?= $clases_label['password'] ?>">Contraseña <br> Debe contener una minuscula, una mayuscula, un digito y un signo de puntuacion </label>
                ...
                <div class="mb-6">
                    ...
                    <?php endif ?>
                    <?php if (isset($error['password_validada'])): ?>
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-bold">¡Error!</span> <?= $error['password_validada'] ?></p>
                    <?php endif ?>
                </div>
